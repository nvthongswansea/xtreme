...
type FileManagerService interface {
	// GetDirUUIDByPath gets a directory's UserUUID by a given path.
	...
	// It returns a new file UserUUID, if success.
	...
	// UploadFile returns a new file UserUUID, if success.
